...
The cream/yellow microbes may have already been resistant to Ampicillin, allowing them to outcomplete other microbes in the water sample, or there may have been less preexisting resistance of the other microbes to Ampicillin, allowing the cream/yellow microbes to propagate (and/or develop further antibiotic resistance) without competition. The darkening of colour of the cream/rust gradient over time looks to be the microbe drying out, since it doesn't further move along the antibiotic gradient after October 28 (seems to have reached carrying capacity at this time).
