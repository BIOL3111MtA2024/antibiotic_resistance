...
##omparison across antibiotics (to find the most effective antibiotic).
...
## Plot of flow type against relative count of colonies  
```{r Flow_relative}
flow_relative %>%
  ggplot()+
  geom_bar(aes(x = InOut, y = TotalCount, colour = InOut, fill = InOut ), stat = "identity")
```
